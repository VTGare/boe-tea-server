...
import (
	...
	"github.com/VTGare/boe-tea-backend/internal/validate"
	mo "github.com/VTGare/boe-tea-backend/pkg/artworks/options"
...
func NewService(db *database.DB, logger *zap.SugaredLogger) Service {
